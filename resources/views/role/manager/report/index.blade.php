                    ...
                    @else
                        @foreach ($projects as $project)
                            <a class="dropdown-item"
                                href="{{ route('manager.report.index', ['project_id' => $project->id]) }}">
                        ...
                        <div class="modal-body">
                            <ul class="list-group">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="reject-name" type="text" class="form-control" name="name" value=""
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="reject-manager-by" type="text" class="form-control" name="manager_by"
                                            value="" required autocomplete="manager_by" autofocus>
                                    </div>
                                </div>
