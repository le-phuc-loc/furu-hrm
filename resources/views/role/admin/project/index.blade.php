                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="update-from-date" type="date" class="form-control @error('from_date') is-invalid @enderror" name="from_date">
                                        </div>
                                        @error('from_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="update-to-date" type="date" class="form-control @error('to_date') is-invalid @enderror" name="to_date">
                                        </div>
                                        @error('to_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="time" id="update-time-checkin" class="form-control @error('time_checkin') is-invalid @enderror" name="time_checkin">
                                        </div>
                                        @error('time_checkin')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="time" id="update-time-checkout" class="form-control @error('time_checkout') is-invalid @enderror" name="time_checkout">
                                        </div>
                                        @error('time_checkout')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
