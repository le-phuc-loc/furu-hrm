        ...
        <div class="col-12 ">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        @csrf
                        <div class="modal fade" id="updateProject" tabindex="-1" role="dialog" aria-labelledby="updateLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                ...
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>5</td>
                            <td>
                                <button type="button" data-toggle="modal" data-target="#myModal" style="float: left;">
                                    Update
                                </button>
                                <button syle="align:right;"
                                    onclick="return confirm('Are you sure you want to delete this item?');">Delete
                                </button>
                            </td>
                        </tr>
