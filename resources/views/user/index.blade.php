    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h1 class="mt-4">List of Reports</h1>
                    </div>
                </div>
                <br>
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <button type="button" class="btn btn-info add-new" data-toggle="modal"
                                    data-target="#create-user" style="float: right;"> <i class="fa fa-plus"></i>
                                    Create
                                </button>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @if(count($users) <= 0) <div class="list-group-item list-group-item-action"> Don't
                                                have Worker
                                </div>
                            @else
                                {{-- <div>adadasdasd</div> --}}
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-primary btn-user-edit" data-toggle="modal"
                                                data-target="#update-user"
                                                value="{{ route('user.edit', ['id' => $user->id]) }}">
                                                Edit
                                            </button>
                                            <a type="button" class="btn btn-primary btn-user-delete"
                    ...
                    $(".btn-user-edit").click(function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                $("#user-update-form").attr('action', "/user/update/" + result
                                    .user.id);
                            }
                        });
                    });
