                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="role" type="text" class="form-control" name="role" required autocomplete="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="manager" type="number" class="form-control" name="manager" required autocomplete="manager">
                            </div>
                        </div>
